package com.nhinguyen.translate.activity
...
import com.nhinguyen.translate.ROOM.WordItemClickListener
import kotlinx.android.synthetic.main.word_item.view.*
import java.util.*

class FolderActivityAdapter(var items: ArrayList<Word>, val context: Context) : RecyclerView.Adapter<WordViewHolder>(){
